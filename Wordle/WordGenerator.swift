...
class WordGenerator {
  ...
  static let possibleWords = ["AUDIO", "BRAVE", "CHAIR", "DELTA", "EAGLE",
                              "FLAME", "GHOST", "HAPPY", "IVORY", "JUMPY",
                              "KNOCK", "LIGHT", "MAGIC", "NOBLE", "OCEAN",
                              "POWER", "QUIET", "RIVER", "STORM", "TIGER",
                              "UNION", "VOTER", "WATER", "XENON", "YOUTH", "ZEBRA"]
  static func generateRandomWord() -> String? {
    // START YOUR CODE HERE
      
      return possibleWords.randomElement() ?? "ERROR"
    // END YOUR CODE HERE
  }
}
